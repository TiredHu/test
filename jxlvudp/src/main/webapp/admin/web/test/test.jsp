...
<form class="layui-form" id="ff">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="password" required  lay-verify="required" autocomplete="off" placeholder="请输入分类名称" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">年龄：</label>
        <div class="layui-input-block">
            <input name="age"  autocomplete="off" placeholder="请输入说明" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
    <label class="layui-form-label">性别：</label>
    <div class="layui-input-block">
        <input name="sex"  autocomplete="off" placeholder="请输入说明" class="layui-input" type="text">
    </div>
    </div>
